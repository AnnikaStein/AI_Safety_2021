...
if do_minimal == 'no':
    ...
    val_input_file_paths = [f'/hpcwork/um106329/june_21/scaled_QCD/val_inputs_%d_with_default_{default}.pt' % k for k in range(0,min(NUM_DATASETS,229))] + [f'/hpcwork/um106329/june_21/scaled_TT/val_inputs_%d_with_default_{default}.pt' % k for k in range(0,max(NUM_DATASETS-229,0))]
...
if do_minimal == 'yes':
    train_input_file_paths = [f'/hpcwork/um106329/june_21/scaled_QCD/train_inputs_%d_with_default_{default}.pt' % k for k in range(0,15)] + [f'/hpcwork/um106329/june_21/scaled_TT/train_inputs_%d_with_default_{default}.pt' % k for k in range(0,5)]
    ...
    val_input_file_paths = [f'/hpcwork/um106329/june_21/scaled_QCD/val_inputs_%d_with_default_{default}.pt' % k for k in range(0,15)] + [f'/hpcwork/um106329/june_21/scaled_TT/val_inputs_%d_with_default_{default}.pt' % k for k in range(0,5)]
