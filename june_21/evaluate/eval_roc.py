...
if compare == False:
    ...
    if weighting_method == '_all':
        ...
        fig.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/compare_roc_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        gc.collect(2)
    ...
    if weighting_method == '_noweighting':
        ...
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_b_tagging_weighting_method{weighting_method}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        ...
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_bb_tagging_weighting_method{weighting_method}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
        ...
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_c_tagging_weighting_method{weighting_method}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
        ...
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_udsg_tagging_weighting_method{weighting_method}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
    ...
    if weighting_method == '_ptetaflavloss':
        ...
        plt.ylabel('true positive rate')
        plt.title(f'ROC b tagging after {at_epoch} epochs,\nevaluated on {len_test} jets ({NUM_DATASETS} files, default {default})')
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_b_tagging_weighting_method{weighting_method}{fl_text}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
        ...
        plt.ylabel('true positive rate')
        plt.title(f'ROC bb tagging after {at_epoch} epochs,\nevaluated on {len_test} jets ({NUM_DATASETS} files, default {default})')
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_bb_tagging_weighting_method{weighting_method}{fl_text}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
        ...
        plt.ylabel('true positive rate')
        plt.title(f'ROC c tagging after {at_epoch} epochs,\nevaluated on {len_test} jets ({NUM_DATASETS} files, default {default})')
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_c_tagging_weighting_method{weighting_method}{fl_text}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
        ...
        plt.ylabel('true positive rate')
        plt.title(f'ROC udsg tagging after {at_epoch} epochs,\nevaluated on {len_test} jets ({NUM_DATASETS} files, default {default})')
        plt.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_udsg_tagging_weighting_method{weighting_method}{fl_text}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
        plt.show(block=False)
        time.sleep(5)
        plt.close('all')
        gc.collect(2)
    ...
    if weighting_method == '_all':
        ...
        fig.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/compare_roc_BvL_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
    ...
    if weighting_method == '_noweighting':
        ...
        plt.ylim(-0.05,1.05)
        plt.legend(['Classifier: No weighting', 'DeepCSV'],loc='lower right')
        fig.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_BvL_weighting_method{weighting_method}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
    ...
    if weighting_method == '_ptetaflavloss':
        ...
        plt.ylim(-0.05,1.05)
        plt.legend(['Classifier: Loss weighting', 'DeepCSV'],loc='lower right')
        fig.savefig(f'/home/um106329/aisafety/june_21/evaluate/roc_curves/roc_BvL_weighting_method{weighting_method}{fl_text}_at_epoch_{at_epoch}_{len_test}_jets_training_{NUM_DATASETS}_{default}_{n_samples}.png', bbox_inches='tight', dpi=400)
    '''
        Loss weighting alone (flat)
    '''
    if weighting_method == '_flatptetaflavloss':
