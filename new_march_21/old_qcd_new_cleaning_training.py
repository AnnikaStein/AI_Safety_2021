...
for e in range(epochs):
    ...
    for b, (i,j) in enumerate(trainloader):
        ...
        torch.save({"epoch": prev_epochs+e, "model_state_dict": model.state_dict(), "optimizer_state_dict": optimizer.state_dict(), "loss": running_loss/total_len_train, "val_loss": running_val_loss/total_len_val}, f'/home/um106329/aisafety/new_march_21/models/model_old_QCD_new_cleaning_loss_weighting_{prev_epochs+(e + 1)}_epochs_v10_GPU_weighted{weighting_method}_{NUM_DATASETS}_datasets.pt')
toc = time.time()
...
#torch.save(model, f'/home/um106329/aisafety/new_march_21/models/model_old_QCD_new_cleaning_loss_weighting.pt')
...
plt.savefig(f'/home/um106329/aisafety/new_march_21/training_history_old_QCD_new_cleaning_loss_weighting_{epochs}_epochs.svg', bbox_inches='tight', facecolor='w', transparent=False)
gc.collect()
...
fig.savefig(f'/home/um106329/aisafety/new_march_21/discriminator_shapes_old_QCD_new_cleaning_loss_weighting_{epochs}_epochs.svg', bbox_inches='tight', facecolor='w', transparent=False)
gc.collect()
plt.show(block=False)
time.sleep(5)
plt.clf()
...
plt.savefig(f'/home/um106329/aisafety/new_march_21/ROC_old_QCD_new_cleaning_loss_weighting_{epochs}_epochs.svg', bbox_inches='tight', facecolor='w', transparent=False)
gc.collect()
plt.show(block=False)
time.sleep(5)
plt.close('all')
