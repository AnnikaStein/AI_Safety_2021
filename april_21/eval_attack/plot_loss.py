...
plt.title(f"Training history with {NUM_DATASETS} files, {prev_epochs} epochs, each with default {default}", y=1.02)
plt.xlabel('epoch')
plt.ylabel('loss')
plt.legend()
plt.savefig(f'/home/um106329/aisafety/april_21/eval_attack/plots/{NUM_DATASETS}_full_files_{prev_epochs}_epochs_v13_GPU_train_history_wm{weighting_method_0}{weighting_method_1}_default_{default}.png', bbox_inches='tight', dpi=400, facecolor='w', transparent=False)
